...
var AjaxHelper = {
    ...
    setLoadWaiting: function (e) {
        var t = '<div id="loading" style="display:block"><img src="/public/assets/images/loading-small.gif" alt="loading"><span>Äang xá»­ lÃ½</span></div>';
    ...
    processAjaxError: function (e) {
        alert("CÃ³ lá»—i xáº£y ra. Vui lÃ²ng thá»­ láº¡i..."), setTimeout((function () {
            location.reload()
        }), 100)
    }
};
    ...
    if ($("body").hasClass("chapter-detail")) processComicLoader(!0);
        ...
        if ($(".comics-followed-nopaging").length) e = 1, t = $(".comics-followed");
            ...
            $.ajax({
                ...
                success: function (a) {
                    if (a.success)
                        if (a.followedListHtml) e.html(replaceUrl(a.followedListHtml)), initLazyload(), loadTooltip(), a.pagerHtml && $('<div class="pagination-outter"></div>').html(a.pagerHtml).appendTo(e), $("html, body").animate({
                            scrollTop: 0
                        }, 0, "linear");
                        else if (0 == t) {
                            var i = '<p>Báº¡n chÆ°a theo dÃµi truyá»‡n nÃ o cáº£. Äá»ƒ theo dÃµi truyá»‡n, nháº¥n vÃ o <u>Theo dÃµi</u> nhÆ° hÃ¬nh bÃªn dÆ°á»›i:<br />Báº¡n nÃªn <a href="/Secure/Login.aspx">ÄÄƒng nháº­p</a> Ä‘á»ƒ truy cáº­p truyá»‡n Ä‘Ã£ theo dÃµi cá»§a báº¡n á»Ÿ báº¥t cá»© Ä‘Ã¢u</p><p class="text-center"><img src="/Data/Sites/1/media/huong-dan-theo-doi-truyen.jpg" alt="HÆ°á»›ng dáº«n theo dÃµi truyá»‡n tranh"></img></p>';
                            e.html(i)
                        }
                },
                complete: function (e) {
...
function InitNotifications(e) {
    if (e) {
        var t = '<div class="notifications"><a href="#" title="ThÃ´ng bÃ¡o"><i class="fa fa-comment"></i>';
    ...
    $("body").on("click", ".notifications > a", (function (e) {
        ...
        if (0 == AjaxHelper.loadWaiting) return AjaxHelper.setLoadWaiting(!0), $.ajax({
            ...
            success: function (e) {
                e.success && (e.notifications && ($(".notification-popup").remove(), $('<div class="notification-popup"></div>').html(e.notifications).appendTo($(".notifications")), $(".notifications .notification-count").text("0")), SetUserStorage())
            },
            complete: function (e) {
                AjaxHelper.setLoadWaiting(!1)
            },
...
function InitAccountMenu(e) {
    if (e)
        if (0 == e.status) {
            ...
            var i = '<li class="login-link"><a rel="nofollow" href="/Secure/Login.aspx' + a + '">ÄÄƒng nháº­p</a></li>';
            i += '<li class="register-link"><a rel="nofollow" href="/Secure/Register.aspx' + a + '">ÄÄƒng kÃ½</a></li>', $(".nav-account").html(i), gOpts.login = 0
        } else {
            i = '<li class="dropdown">';
            i += '<a data-toggle="dropdown" class="user-menu fn-userbox dropdown-toggle" href="javascript:void(0)"><img class="fn-thumb" alt="Avatar" src="' + e.avatar + '" /> <span>CÃ¡ nhÃ¢n</span> <i class="fa fa-caret-down"></i></a>', i += '<ul class="dropdown-menu">', i += '<li><a rel="nofollow" href="/Secure/Dashboard.aspx"><i class="fa fa-user"></i> Trang cÃ¡ nhÃ¢n</a></li><li><a rel="nofollow" href="/Secure/ComicFollowed.aspx"><i class="fa fa-book"></i> Truyá»‡n theo dÃµi</a></li><li><a rel="nofollow" class="user-logout" href="/Logoff.aspx"><i class="fa fa-sign-out"></i> ThoÃ¡t</a></li>', i += "</ul>", i += "</li>", $(".nav-account").html(i), gOpts.login = 1
...
function processComicLoader(e) {
    ...
    if (0 == e) {
        ...
        a > 0 && $.ajax({
            ...
            data: o,
            success: function (e) {
                e.success && (e.commentCount && $(".comment-count").text(e.commentCount), e.commentsHtml && ($(".journalItems").html(e.commentsHtml), e.pagerHtml && ($(".sort-comment").parent().removeClass("hidden"), $(".commentpager").html(e.pagerHtml)), pluginInit(), childCommentsInit(), shortenCommentText()), e.followedListHtml && ($(".comics-followed-block").html(e.followedListHtml), initLazyload()), e.followHtml && $(".follow").prepend(e.followHtml), e.readHtml && ($(".read-continue").length ? $(".read-continue").attr("href", $(e.readHtml).attr("href")) : $(".read-action").append(e.readHtml)), e.markAsReadHtml && $(".list-chapter h2.list-title").append(e.markAsReadHtml), e.readChapters && e.readChapters.length > 0 && $(".list-chapter .chapter a").each((function () {
                    !$(this).hasClass("visited") && $.inArray($(this).attr("data-id"), e.readChapters) > -1 && $(this).addClass("visited")
                })), e.commentReplyHtml && ($("body").addClass("modal-open").prepend(e.commentReplyHtml), pluginInit(), childCommentsInit(), shortenCommentText()))
            }
        })
    }
    $.ajax({
...
try {
    if ("undefined" != typeof Storage && void 0 !== localStorage["user-auth"]) {
        ...
        if (user.date) {
            ...
            Math.abs(diff) <= 1800 && (loadFromStorage = !0, PopulateUserData(user))
        }
    }
} catch (e) { }

function PopulateUserData(e) {
    gOpts.userGuid = e.userGuid, gOpts.token = e.token, gOpts.readToken = e.readToken, gOpts.fullName = e.fullName, gOpts.email = e.email, InitNotifications(e), InitAccountMenu(e), PopulateData()
}
...
$("body").hasClass("securepage") && SetUserStorage(), $("span.downarr a").click((function () {
...
$(".alertError").click((function () {
    ...
    $.ajax({
        ...
        success: function () {
            alert("BÃ¡o lá»—i thÃ nh cÃ´ng! Cáº£m Æ¡n báº¡n Ä‘Ã£ pháº£n há»“i. ChÃºng tÃ´i sáº½ fix trong thá»i gian ngáº¯n nháº¥t.");
        }
    })
    ...
    if (0 == AjaxHelper.loadWaiting) {
        ...
        var e = $(this),
            t = null,
            a = $(e).attr("data-id");
        $("body").hasClass("comic-detail") && (t = $(e).parent().find("b")), $.ajax({
            ...
            cache: !0,
            success: function (i) {
                i && i.success ? 1 : i.message && alert(i.message)
            },
            complete: function (e) {
                AjaxHelper.setLoadWaiting(!1)
            },
...
initLazyload(), loadTooltip(), $(".star").length && $(".star").click({
...
if ($("body").hasClass("comic-detail") && !$(".read-continue").length && ("undefined" != typeof Storage && void 0 !== localStorage["visited-comics"] && (items = JSON.parse(localStorage["visited-comics"])).length > 0))
    for (var i = items.length - 1; i >= 0; i--)
        if (items[i].id == gOpts.comicId) {
            var readHtml = $("<a>").html('Äá»c tiáº¿p <i class="fa fa-angle-right"></i>').attr("class", "read-continue btn btn-danger mrb5").attr("href", items[i].chapterUrl);
            ...
            if (3 == t) populateVisitedComicCloud();
                ...
                if (void 0 !== localStorage["visited-comics"]) {
                    var container = $(".visited-actions").empty().addClass("mrb5 text-center"),
                        pageSize = 36;
                    (items = JSON.parse(localStorage["visited-comics"])).length > 0 ? ($(".visited-comics-page").data("items", items.reverse()), populateVisitedComic(1, pageSize), createPaging(items, pageSize)) : $(".visited-comics-page").html("Báº¡n chÆ°a Ä‘á»c truyá»‡n nÃ o.")
                } else $(".visited-comics-page").html("Báº¡n chÆ°a Ä‘á»c truyá»‡n nÃ o.")
        }
    ...
    if (a > 1) {
        for (var i = $("<div>").addClass("pagination-outter"), o = $("<ul>").addClass("pagination visited-pagination"), s = 1; s <= a; s++) {
            ...
            var n = $("<a>").text(s).data("page", s).click((function (e) {
                return e.preventDefault(), $(".visited-pagination li").removeClass("active"), $(this).parent().addClass("active"), populateVisitedComic($(this).data("page"), t), $("html, body").animate({
                    scrollTop: 0
                }, 200, "linear"), !1
            }));
    ...
    if (a) {
        for (var i = a.slice((e - 1) * t, e * t), o = $("<div>").addClass("row").addClass("visited-list"), s = "//st." + gOpts.host, r = 0; r < i.length; r++) {
            var n = i[r],
                ...
                m = ($("<img>").addClass("lazy").attr("alt", n.name).attr("data-original", 0 != n.image.indexOf("/data/") ? n.image : s + n.image).attr("src", "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7").data("id", n.id).on("error", (function (e) {
                    validateComic(this)
                })).appendTo(p), $("<div>").addClass("view"));
            $("<a>").addClass("visited-remove").attr("href", "#").data("id", n.id).html('<i class="fa fa-times"></i> XÃ³a').click((function (e) {
            ...
            var u = $("<figcaption>"),
                ...
                v = $("<a>").html("Äá»c tiáº¿p " + (0 == n.chapterName.indexOf("Chapter") ? n.chapterName : " " + n.chapterName) + ' <i class="fa fa-angle-right"></i>').attr("href", n.chapterUrl),
...
if ($(".visited-comics").length && ("undefined" != typeof Storage && void 0 !== localStorage["visited-comics"] && (items = JSON.parse(localStorage["visited-comics"])).length > 0)) {
    container = $("<div>").addClass("box darkBox").html('<h2>Lá»‹ch sá»­ Ä‘á»c truyá»‡n<a class="view-all" href="/lich-su">Xem táº¥t cáº£</a></h2>');
    ...
    for (i = items.length - 1; i >= 0; i--) {
        ...
        $("<img>").attr("alt", element.name).attr("src", 0 != element.image.indexOf("/data/") ? element.image : imageSiteRoot + element.image).data("id", element.id).on("error", (function (e) {
            validateComic(this)
        ...
        var p = $("<p>").addClass("chapter"),
            aViewMore = $("<a>").html("Äá»c tiáº¿p " + (0 == element.chapterName.indexOf("Chapter") ? element.chapterName : " " + element.chapterName) + ' <i class="fa fa-angle-right"></i>').attr("href", element.chapterUrl),
            span = $("<span>").addClass("view pull-right"),
            remove = $("<a>").addClass("visited-remove").attr("href", "#").data("id", element.id).html('<i class="fa fa-times"></i> XÃ³a').click((function (e) {
                return e.preventDefault(), removeVisitedComic($(this)), !1
            })).appendTo(span);
    ...
    if ([].forEach.call(a, (function (e, a) {
        ...
        function l(t) {
            if (null != t) {
                ...
                } else "top-members" == a ? 0 == r && (
                    // $.ajax({
                    //     type: "GET",
                    //     url: "/Comic/Services/ComicService.asmx/TopMembers?top=5",
                    //     success: function (e)
                    //     {
                    //         e && 1 == e.success && ($(".top-members").html(e.data), initLazyload())
                    //     }
                    // }), 
                    r = !0
        ...
        function d() {
            ...
            }, e = document, t = "script", a = "facebook-jssdk", o = e.getElementsByTagName(t)[0], e.getElementById(a) || ((i = e.createElement(t)).id = a, i.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=745819368841087&version=v2.7", o.parentNode.insertBefore(i, o))
        }
    }
}
